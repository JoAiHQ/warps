...
export function generateTypes() {
  ...
  warpFiles.forEach(warpFile => {
    ...
    if (!typesByDirectory[dir]) {
        typesByDirectory[dir] = [];
    }
    typesByDirectory[dir].push({ warp, warpFile });
  });

  Object.entries(typesByDirectory).forEach(([dir, items]) => {
    ...
    fs.writeFileSync(filePath, typeContent.trim() + '\n');
    console.log(`Generated types in ${filePath}`);
  });
}
