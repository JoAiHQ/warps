      ...
      apps: [
        {
          ...
          providers: {
            claude: { provider: 'claude', enabled: true, status: 'ready', title: 'Claude Plugin', description: 'Test', notes: [] },
            codex: { provider: 'codex', enabled: true, status: 'ready', title: 'Codex Plugin', description: 'Test', notes: [] },
            cursor: { provider: 'cursor', enabled: true, status: 'ready', title: 'Cursor Plugin', description: 'Test', notes: [] },
            openai: { provider: 'openai', enabled: true, status: 'submission_ready', title: 'ChatGPT App', description: 'Test', notes: [] },
          },
          actions: [],
        },
      ],
