...
export const brand = async (config: WarpClientConfig): Promise<WarpbaseBrand> => ({
  ...
  site: {
    ...
    routes: [
      ...
      { path: '/admin/create', warp: '@poll-poll-create', label: { en: 'Create Poll', de: 'Abstimmung erstellen', fr: 'Creer un sondage', es: 'Crear encuesta', ro: 'Creeaza sondaj' }, nav: true, hiddenFields: ['GROUP_SLUG'] },
