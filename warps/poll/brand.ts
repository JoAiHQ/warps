...
export const brand = async (config: WarpClientConfig): Promise<WarpbaseBrand> => ({
  ...
  contracts: {
    POLL_SC_ADDRESS: (env: WarpChainEnv) => {
      if (env === 'devnet') return 'erd1qqqqqqqqqqqqqpgqd0xs0nr4m4g53lhqx5xfdvywz3ka9yc0tresaz5uq0'
  ...
  site: {
    ...
    routes: [
      ...
      { path: '/groups', warp: '@poll-groups', label: { en: 'Groups', de: 'Gruppen', fr: 'Groupes', es: 'Grupos', ro: 'Grupuri' }, nav: true, hiddenFields: ['GROUP_SLUG'] },
      { path: '/join', warp: '@poll-membership-request', label: { en: 'Join Group', de: 'Gruppe beitreten', fr: 'Rejoindre le groupe', es: 'Unirse al grupo', ro: 'Alatura-te grupului' }, nav: false, hiddenFields: ['GROUP_SLUG'] },
      ...
      { path: '/admin/create', warp: '@poll-create', label: { en: 'Create Poll', de: 'Abstimmung erstellen', fr: 'Creer un sondage', es: 'Crear encuesta', ro: 'Creeaza sondaj' }, nav: true, hiddenFields: ['GROUP_SLUG'] },
