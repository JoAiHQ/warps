...
export const brand = async (config: WarpClientConfig): Promise<WarpbaseBrand> => ({
  ...
  site: {
    ...
    indexPath: '/',
    routes: [
      { path: '/', warp: '@poll-polls-active', label: { en: 'Polls', de: 'Abstimmungen', fr: 'Sondages', es: 'Encuestas', ro: 'Sondaje' }, nav: true, hiddenFields: ['SLUG'] },
      ...
      { path: '/join', warp: '@poll-membership-request', label: { en: 'Join Group', de: 'Gruppe beitreten', fr: 'Rejoindre le groupe', es: 'Unirse al grupo', ro: 'Alatura-te grupului' }, nav: true, hiddenFields: ['SLUG'] },
      { path: '/join-invite', warp: '@poll-invite-join', label: { en: 'Join with Invite', de: 'Mit Einladung beitreten', fr: 'Rejoindre avec une invitation', es: 'Unirse con invitacion', ro: 'Alatura-te cu invitatie' }, nav: false, hiddenFields: ['SLUG'] },
      ...
      { path: '/admin/requests', warp: '@poll-requests-pending', label: { en: 'Requests', de: 'Anfragen', fr: 'Demandes', es: 'Solicitudes', ro: 'Cereri' }, nav: false, hiddenFields: ['SLUG'] },
      { path: '/admin/invite', warp: '@poll-invite-create', label: { en: 'Invite', de: 'Einladen', fr: 'Inviter', es: 'Invitar', ro: 'Invita' }, nav: false, hiddenFields: ['SLUG'] },
    ],
  },
})
