...
export const es: typeof en = {
  book: {
    ...
    cancelConfirmNo: 'Mantener',
    cancelReasonLabel: 'Motivo (opcional)',
    cancelReasonPlaceholder: '¿Por qué cancelas?',
  ...
  configure: {
    ...
    fields: {
      ...
      paymentEnabled: 'Requerir pago en marketplace',
  ...
  policyGet: {
    ...
    empty: 'Aún no hay una política de citas configurada.',
    active: 'Activa',
    inactive: 'Inactiva',
    officeHours: 'Horario de atención',
    noHours: 'No hay horario de atención definido.',
    bookingRules: 'Reglas de reserva',
    details: 'Detalles',
    editSettings: 'Editar ajustes',
    yes: 'Sí',
    no: 'No',
    syncEnabled: 'Sincronizado con el horario del lugar',
    syncDisabled: 'Sin sincronizar',
    syncError: 'Error de sync',
    fields: {
      slotInterval: 'Intervalo de horarios',
      bufferAfter: 'Margen posterior',
      minNotice: 'Aviso mínimo',
      maxDaysAhead: 'Días de anticipación máx',
      capacity: 'Capacidad',
      requireApproval: 'Requiere aprobación',
      notificationEmail: 'Email de notificación',
      conferenceEnabled: 'Enlace de reunión online',
      serviceSelectionEnabled: 'Selección de servicio',
      paymentEnabled: 'Pago en marketplace',
      blockedDates: 'Fechas bloqueadas',
      holidays: 'Festivos',
      agent: 'Agente de reservas',
      sync: 'Sync de horario',
      minutesUnit: 'min',
      daysUnit: 'días',
      capacityUnits: {
        booking: 'reserva',
