...
function Main() {
  const { data } = useAppContext<TransactionData>()
  ...
  return (
    <div className="flex flex-col gap-4 p-4 max-w-lg mx-auto">
      <div className="text-center mb-2">
        ...
        <Badge color={statusColor}>{statusIcon} {data.STATUS}</Badge>
      </div>
        ...
        <div className="flex items-center justify-center mb-4">
          <div className="text-center">
            ...
            <Tooltip content={data.TX_HASH}>
              <p className="font-mono text-sm cursor-help">{shortenHash(data.TX_HASH)}</p>
            </Tooltip>
            <a
              href={explorerUrl}
              target="_blank"
